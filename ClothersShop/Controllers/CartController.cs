...
namespace ClothersShop.Controllers
{
    public class CartController : Controller
    {
        ...
        public ActionResult Payment(string shipName, string name, string mobile, string address, string email)
        {
            var order = new Order();
            ...
            try
            {
                ...
                string content = System.IO.File.ReadAllText(Server.MapPath("~/assets/client/assets/template/neworder.html"));
